        ...
        <div class="container">
            <div class="row">
                <div class="ftco-animate py-md-5 mt-md-5">
                    ...
                    <p>
                        To build a strong knowledge base on the numerous tools and procedures needed to comprehend how
                        capital markets operate. IISM launched the Certiﬁcation in Online Stock Market for Beginners. It is
                    ...
                    <p>
                        It provides a fundamental understanding of terms including equity, initial public offerings (IPOs),
                        derivatives, technical analysis of the stock market, macroeconomics, and ﬁnancial planning. It is
                        the ideal combination
                        of technical analysis, which will use chart analysis to determine the optimal entry and exit points
                        and prices, and fundamental analysis of stocks, which will assist the investor in selecting the best
                        ﬁrm
                    </p>
                            ...
                            <div class="col-sm">
                                <div class="">
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            If you’re interested in ﬁnding out the beneﬁts and drawbacks of investing in the
                                            stock market
                                        </li>
                                        <li>
                                            If you wish to increase your fortune in the stock market while staying in a
                                            bank’s air conditioning,
                                        </li>
                                    </ol>
                                </div>
                            </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td data-label="Fees">₹40,000+GST</td>
